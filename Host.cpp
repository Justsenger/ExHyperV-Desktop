...
int main() {
    ...
    // 指定注册服务的GUID
    CLSID ServiceID;
    const wchar_t* clsid_str = L"{2b174636-bc38-474e-9396-b87f3877c1e8}";
    ...
    while (true) { // This loop ensures the server keeps running and waiting for new connections.
        ...
        // 缩小后的窗口尺寸
        int windowWidth = static_cast<int>(1920 * 0.8);  // 计算0.8倍的宽度
        int windowHeight = static_cast<int>(1080 * 0.8); // 计算0.8倍的高度
        ...
        while (true) {
            ...
            DisplayImage(hdc, imageData, 1920, 1080, clientWidth, clientHeight);
